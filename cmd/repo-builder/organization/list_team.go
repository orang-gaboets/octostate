...
func ListOrgTeamsCmd(svc teams.Service) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `
			repo-builder organization list-teams --token <token> --org <org-name>
			repo-builder organization list-teams --app-id <app-id> --installation-id <installation-id> --app-key-path <path-to-app-key> --org <org-name>`,
		RunE: func(cmd *cobra.Command, _ []string) error {
			...
			_, err := teams.ListTeams(ctx, opts)
			return err
		},
	}
