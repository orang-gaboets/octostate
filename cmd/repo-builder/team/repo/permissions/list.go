...
func ListCmd(svc teams.Service) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `
			repo-builder team repo permissions list --token <token> --org <org-name> --slug <team-slug>
			repo-builder team repo permissions list --app-id <app-id> --installation-id <installation-id> --app-key-path <path-to-app-key> --org <org-name> --slug <team-slug>`,
