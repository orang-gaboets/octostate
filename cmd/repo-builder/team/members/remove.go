...
func RemoveCmd(svc teams.Service) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `
			repo-builder team members remove --token <token> --org <org-name> --slug <team-slug> --username <username>
			repo-builder team members remove --token <token> --org <org-name> --slug <team-slug> --username <username> --dry-run
			repo-builder team members remove --app-id <app-id> --installation-id <installation-id> --app-key-path <path-to-app-key> --org <org-name> --slug <team-slug> --username <username>`,
